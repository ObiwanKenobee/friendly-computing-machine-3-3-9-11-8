# QuantumVest Infrastructure as Code
...
resource "aws_elasticache_replication_group" "main" {
  description       = "QuantumVest Redis cluster"
  ...
  container_definitions = jsonencode([
    {
      ...
      healthCheck = {
        command     = ["CMD-SHELL", "node health-check.js"]
        interval    = 30
        timeout     = 10
        retries     = 3
        startPeriod = 60
...
resource "aws_ssm_parameter" "redis_url" {
  ...
  type  = "SecureString"
  value = "rediss://:${random_password.redis_auth_token.result}@${aws_elasticache_replication_group.main.configuration_endpoint_address}:6379"
